...
# BOOTLOADER = custom
#BOOTLOADER = stm32duino  #生成bin文件
#BOOTLOADER = uf2boot      #生成uf2文件
BOOTLOADER = vibl        #生成bin和vfw文件
...
POINTING_DEVICE_ENABLE = yes                 # 指点杆
POINTING_DEVICE_DRIVER = analog_joystick     # 指点杆

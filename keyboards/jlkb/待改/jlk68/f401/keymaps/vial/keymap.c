...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	LAYOUT(
		...
		KC_TAB, KC_W, KC_TRNS, KC_T, KC_Y, KC_I, KC_P, KC_TRNS, DIAL_L,
		KC_Q, KC_E, KC_R, KC_TRNS, KC_U, KC_O, KC_LBRACKET, KC_HOME, KC_RBRACKET,
		KC_CAPSLOCK, KC_S, KC_F, KC_H, KC_TRNS, KC_L, KC_SCOLON, KC_PGUP, KC_BSLASH,
		KC_A, KC_D, KC_G, KC_J, KC_K, KC_TRNS, KC_QUOTE, KC_PGDOWN, KC_ENTER,

...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all(
    BLE_TOG, BLE_TOG,    BLE_TOG,     BLE_TOG,     BLE_TOG,    KC_5,    KC_6,    KC_7,    KC_8,      BLE_TOG,     BLE_TOG,     BLE_TOG,  BLE_TOG,  KC_BSLS, KC_BSPC,
    BLE_TOG,  BLE_TOG, BLE_TOG,  BLE_TOG,     KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,      KC_O,     KC_P,     BLE_TOG,  KC_RBRC, KC_BSLS,
    BLE_TOG, BLE_TOG, USB_TOG,  NK_TOGG,     KC_F,    KC_G,    KC_H,    KC_J,    KC_K,      KC_L,     KC_SCLN,  BLE_TOG,  KC_BSLS, KC_ENT,
    BLE_TOG, KC_Z,    KC_X,     KC_C,     KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM,   KC_DOT,   KC_SLSH,  KC_RSFT,  KC_UP,   KC_DEL,
